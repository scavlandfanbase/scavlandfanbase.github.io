...
- `armour.html` reads `data/armour.json`; **10/31** records currently meet the screenshot-verification threshold. Armour resistance evidence requires a screenshot at **100% durability**.
...
- `items.html` reads the structured JSON sources. `data/items.json` currently has **180/256** screenshot-verified records.
